...
def test_evidence_integrity_role_mismatch_warning() -> None:
    plan = PlanResponse(
        ...
        evidence_panel=[_evidence(evidence_id="ev-1", role_id="ROLE_B", skill_id="SK_X")],
    )
    ...
    assert warning.details.get("kind") == "role_mismatch"
